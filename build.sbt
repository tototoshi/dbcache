...
lazy val postgresqlDependency = "org.postgresql" % "postgresql" % "42.3.2"

lazy val testDependencies = Seq(
  "org.flywaydb" % "flyway-core" % "8.4.4" % "test",
  "org.flywaydb" % "flyway-mysql" % "8.4.4" % "test",
...
lazy val examplePlay = (project in file("example-play"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.flywaydb" %% "flyway-play" % "7.19.0" cross CrossVersion.for3Use2_13
    ),
    playScala3workaround,
